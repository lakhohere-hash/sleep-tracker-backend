...
const MONGODB_URI = 'mongodb+srv://sleepapp:SleepApp12345@cluster0.qyenjoe.mongodb.net/sleep_tracker?retryWrites=true&w=majority&appName=Cluster0';
...
app.get('/api/videos/stats', async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, error: 'Failed to fetch video statistics' });
    }
});
...
app.listen(PORT, () => {
    ...
    console.log(`📡 ALL 35+ APIs READY at: https://sleep-tracker-backend-0a9f.onrender.com/api`);
